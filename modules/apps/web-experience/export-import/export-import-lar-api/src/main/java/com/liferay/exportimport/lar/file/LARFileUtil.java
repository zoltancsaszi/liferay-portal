...
import com.liferay.exportimport.lar.file.internal.LARFileImpl;
...
public class LARFileUtil {
	...
	private static final ThreadLocal<LARFile> _larFile =
		new CentralizedThreadLocal<>(LARFileUtil.class + "._larFile", null);

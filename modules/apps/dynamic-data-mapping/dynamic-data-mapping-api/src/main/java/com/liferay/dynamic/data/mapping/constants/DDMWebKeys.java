...
public class DDMWebKeys {
	...
	public static final String DYNAMIC_DATA_MAPPING_STRUCTURE_VERSION =
		"DYNAMIC_DATA_MAPPING_STRUCTURE_VERSION";

	public static final String DYNAMIC_DATA_MAPPING_TEMPLATE =
		"DYNAMIC_DATA_MAPPING_TEMPLATE";

	public static final String DYNAMIC_DATA_MAPPING_TEMPLATE_VERSION =
		"DYNAMIC_DATA_MAPPING_TEMPLATE_VERSION";

...
import com.liferay.hello.staging.model.BookingModel;
...
/**
 * The base model implementation for the Booking service. Represents a row in the &quot;SampleLAR_Booking&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
...
public class BookingModelImpl extends BaseModelImpl<Booking>
	 ...
	 */
	public static final String TABLE_NAME = "SampleLAR_Booking";
	...
	public static final String TABLE_SQL_CREATE = "create table SampleLAR_Booking (uuid_ VARCHAR(75) null,bookingId LONG not null primary key,groupId LONG,companyId LONG,userId LONG,userName VARCHAR(75) null,createDate DATE null,modifiedDate DATE null,bookingNumber VARCHAR(75) null,lastPublishDate DATE null)";
	public static final String TABLE_SQL_DROP = "drop table SampleLAR_Booking";
	public static final String ORDER_BY_JPQL = " ORDER BY booking.bookingNumber ASC";
	public static final String ORDER_BY_SQL = " ORDER BY SampleLAR_Booking.bookingNumber ASC";
	...
	public static final boolean ENTITY_CACHE_ENABLED = GetterUtil.getBoolean(com.liferay.hello.staging.service.util.ServiceProps.get(
				"value.object.entity.cache.enabled.com.liferay.hello.staging.model.Booking"),
			true);
	public static final boolean FINDER_CACHE_ENABLED = GetterUtil.getBoolean(com.liferay.hello.staging.service.util.ServiceProps.get(
				"value.object.finder.cache.enabled.com.liferay.hello.staging.model.Booking"),
			true);
	...
	public Object clone() {
		...
		bookingImpl.setBookingNumber(getBookingNumber());
		bookingImpl.setLastPublishDate(getLastPublishDate());
	...
	public void resetOriginalValues() {
		...
		bookingModelImpl._originalBookingId = bookingModelImpl._bookingId;

		bookingModelImpl._setOriginalBookingId = false;
	...
	public CacheModel<Booking> toCacheModel() {
		...
		bookingCacheModel.bookingNumber = getBookingNumber();

		String bookingNumber = bookingCacheModel.bookingNumber;

		if ((bookingNumber != null) && (bookingNumber.length() == 0)) {
			bookingCacheModel.bookingNumber = null;
		}

		Date lastPublishDate = getLastPublishDate();

		if (lastPublishDate != null) {
			bookingCacheModel.lastPublishDate = lastPublishDate.getTime();
		}
		else {
			bookingCacheModel.lastPublishDate = Long.MIN_VALUE;
		}
	...
	public String toXmlString() {
		...
		sb.append("com.liferay.hello.staging.model.Booking");

...
@Component(
	...
	property = {
		...
		"mvc.command.name=/room/add"
	},
	service = MVCActionCommand.class
)
public class AddRoomMVCActionCommand extends BaseMVCActionCommand {
	...
	protected void doProcessAction(
		...
		String roomNumber =
			"Room-" + GetterUtil.getInteger(Math.random() * 100);

		_roomLocalService.addRoom(
			themeDisplay.getUserId(), themeDisplay.getScopeGroupId(),
			sampleLARBookingId, roomNumber, new ServiceContext());
	}
